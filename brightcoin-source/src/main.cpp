...
#if defined(NDEBUG)
# error "BrightCoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xa4e356db453f2638483b86af4969e69cd14996bcfef4ce73a4532426f78109af");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // BrightCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "BrightCoin Signed Message:\n";
...
{
    // BrightCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // BrightCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // BrightCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa4e356db453f2638483b86af4969e69cd14996bcfef4ce73a4532426f78109af");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1450012444, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "COP21 climate change summit reaches deal in Paris    BBC NEWs";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 500 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("049969e8b5319c3acf19cdf8f445b7f9e8036fb9d7ff3305c8ba7a53d76461ee26187f57bae3544483f6b4aae412d95cfb4d2a5a5cbb19afcf20492e75b5f2e850") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1450012444;
        ...
        assert(block.hashMerkleRoot == uint256("0x3f48f492c76da970e95c4105312748fc9f36bff0936284fd7ed41767c8564eda"));
...
unsigned char pchMessageStart[4] = { 0x90, 0x85, 0xac, 0xfb }; // BrightCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BrightCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BrightCoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static BrightCoinMiner(CWallet *pwallet)
{
    printf("BrightCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("brightcoin-miner");
    ...
    try { loop {
        ...
        printf("Running BrightCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("BrightCoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&BrightCoinMiner, pwallet));
}
